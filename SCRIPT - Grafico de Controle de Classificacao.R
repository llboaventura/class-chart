...
Tamanho.amostras = 250 # (sample's size)
Densidade.y =  "simetrico" # "Assimetrico" # (Symmetry of data distribution)
Volume.dos.dados = "Nao.Big" # "Big" " #(Num of predictors)
Presenca.de.Multicolinearidade = "X.indep" # X.multicol #(Relationship between predictors)
q = c(0,0.1,0.4,0.6,1) # Criterio de Discretização #(discretization quantiles)
